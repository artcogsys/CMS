...
train_iter = SequentialIterator(ClassificationTimeseries(), batch_size=32)
val_iter = SequentialIterator(ClassificationTimeseries(), batch_size=32)
...
world.test(SequentialIterator(ClassificationTimeseries(), batch_size=1), n_epochs=1, plot=False)
